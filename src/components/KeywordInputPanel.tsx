...
export const KeywordInputPanel = ({ value, onChange, onFileText }: KeywordInputPanelProps) => {
  ...
  return (
    <section className="card space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-300">
            يدعم JSON nested arrays مثل <span dir="ltr" className="font-mono text-cyan-200">[batch1, batch2]</span> أو كلمات مفصولة بأسطر/فواصل.
          </p>
        </div>
      ...
      <textarea
        ...
        placeholder={'[\n  ["غرف نوم مودرن", "ركنه مودرن"],\n  ["انتريه حديث", "سفرة ٨ كراسي"]\n]'}
      />
